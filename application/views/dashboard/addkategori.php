      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td><?php echo $kat_item['idkategori']?></td>
              <td><?php echo $kat_item['kategori']?></td>
              
              <td>
               <?php echo anchor('book/editKategori/'.$kat_item['idkategori'], 'Edit |', 'Edit Kategori'); ?>
               <?php echo anchor('book/deleteKategori/'.$kat_item['idkategori'], 'Del', 'Hapus Kategori'); ?> </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
